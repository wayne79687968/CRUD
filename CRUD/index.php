                            ...
                            echo 
                                '<tr>
                                  ...
                                  '</td><td scope="col" class="text-center">
                                        <button style="white-space:nowrap" type="button" data-id="' . $row["id"] . ',' . $row["account"] . ',' . $row["name"] . ',' . $row["gender"] . ',' . $row["birthday"] . ',' . $row["email"] . ',' . $row["remark"] . '" class="btn btn-dark edit" data-toggle="modal" data-target="#editModal">編輯</button>
                                        <br><br>
